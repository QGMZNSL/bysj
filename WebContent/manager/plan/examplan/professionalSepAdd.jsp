...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!-- 编辑区域 -->
		<form action="<%=request.getContextPath()%>/plan/proseq_Add.do"	method="post" name="addForm">
			...
			<div class="infoedit">
				...
				<dl>
					...
					<dd>
						<input class="inputText" type="text" name="proseq.proPartCode" id="proPartCode" value="" />
				...
				<dl>
					...
					<dd>
						<input class="inputText" type="text" name="proseq.proPartName" id="proPartName" value="" />
				...
				<dl>
					...
					<dd>
						<input class="inputText" type="text" name="proseq.remarks" id="remarks" value="" />
					</dd>
				</dl>
				<div class="clear"></div>
			</div>
