...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<iframe name="ifm" id="helpIfm" scrolling="no" frameborder="0" width="100%" style="display: none;" onload="this.height=this.contentWindow.document.body.scrollHeight+13"></iframe>
		...
		<!-- 编辑区域 -->
		<form action="<%=request.getContextPath()%>/plan/protype_Add.do" method="post" name="addForm">
		...
		<div class="infoedit">
				<dl>
					...
					<dd>
						<input class="inputText" type="text"  name="protype.proTypeCode" id="proTypeCode" value="" />
						<v:v input="protype.proTypeCode" exp="s(1)">请输入专业类型代码！(长度不能超过1位)</v:v>
					</dd>
				</dl>
				<dl>
					<dt>
					...
					<dd>
						<input class="inputText" type="text" name="protype.proTypeName" id="proTypeName" value="" />
				...
				<dl>
					...
					<dd>
						<input class="inputTextarea" type="text" name="protype.remarks" id="remarks" value="" />
					</dd>
				</dl>
				<div class="clear"></div>				
		</div>
