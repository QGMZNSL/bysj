...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!-- 编辑区域 -->
		<form action="<%=request.getContextPath()%>/plan/level_Edit.do"	method="post" name="addForm">
			...
			<div class="infoedit">
				...
				<dl>
					...
					<dd>
						<input class="inputText" type="text" name="planlevel.levelCode" id="levelCode" value="${planlevel.levelCode}" />							
					</dd>
				</dl>
				<dl>
					<dt>
					...
					<dd>
						<input class="inputText" type="text" name="planlevel.levelName" id="levelName" value="${planlevel.levelName}" />
						<v:v input="planlevel.levelName" exp="name(1,50)|cname(1,50)|ename(1,50)">请输入层次名称！(长度必须小于10位，不能输入怪字符)</v:v>
					</dd>
				</dl>
				<div class="clear"></div>
			</div>
