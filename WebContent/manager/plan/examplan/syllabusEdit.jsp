...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!-- 编辑区域 -->
		<form action="<%=request.getContextPath()%>/plan/syllabus_Edit.do"
			...
			<v:bean clazz="com.sincinfo.zxks.core.plan.SyllabusAction"
				...
				<div class="infoedit">
					...
					<dl>
						...
						<dd>
							<input class="inputText" type="text" name="syllabus.syllabusCode"
								id="syllabusCode" value="${syllabus.syllabusCode}" />
					...
					<dl>
						...
						<dd>
							<input class="inputText" type="text" name="syllabus.syllabusName"
								id="syllabusName" value="${syllabus.syllabusName}" />
					...
					<dl>
						...
						<dd>
							<input class="inputText" type="text"
								name="syllabus.syllabuscredit" id="syllabuscredit"
								value="${syllabus.syllabuscredit}" />
					...
					<dl>
						...
						<dd>
							<input class="inputText" type="text" name="syllabus.textbookName"
								id="textbookName" value="${syllabus.textbookName}"
					...
					<dl>
						...
						<dd>
							<input type="radio" name="syllabus.isgb" id="isgb" value="1"
								<c:if test="${syllabus.isgb eq '1' }">checked="checked"</c:if> />
							是
							<input type="radio" name="syllabus.isgb" id="isgb" value="0"
								<c:if test="${syllabus.isgb eq '0' }">checked="checked"</c:if> />
							否
						</dd>
					</dl>
					<dl>
						...
						<dd>
							<input class="inputTextarea" type="text" name="syllabus.remarks"
								id="remarks" value="${syllabus.remarks}" />
						</dd>
					</dl>
					<div class="clear"></div>
				</div>
