...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!-- 编辑区域 -->
		<form action="<%=request.getContextPath()%>/plan/baseacademy_Add.do" method="post" name="addForm">
			...
			<div class="infoedit">
				...
				<dl>
					<dt>主考院校代码：</dt>
			  		<dd>
						<input class="inputText" type="text" name="baseacademy.academyCode" id="academyCode" value="" />
		    	...
		    	<dl>
		    		<dt>主考院校名称：</dt>
			    	<dd>
						<input class="inputText" type="text" name="baseacademy.academyName" id="academyName" value="" />
		    	...
		    	<dl>
		    		<dt>地址：</dt>
			   		<dd>
						<input class="inputText" type="text" name="baseacademy.academyAddress" id="academyAddress" value="" />
		    	...
		    	<dl>
		    		<dt>联系人：</dt>
			   		<dd>
						<input class="inputText" type="text" name="baseacademy.academyLinkman" id="academyLinkman" value="" />
		    	...
		    	<dl>
		    		<dt>联系方式：</dt>
			    	<dd>
						<input class="inputText" type="text" name="baseacademy.academyTelephone" id="academyTelephone" value="" />
		    	...
		    	<dl>
			   		<dt>备注：</dt>
			    	<dd>
						<input class="inputText" type="text" name="baseacademy.remarks" id="remarks" value="" />
					</dd>
		    	</dl>
			    <div class="clear"></div>
		</div>
		...
		<input class="inputButton" type="button" value="返 回" onclick="location.href='<%=request.getContextPath()%>/plan/baseacademy_Show.do'" /></div>
		</v:bean>
	  </form>
	</body>
</html>
