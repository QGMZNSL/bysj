...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!-- 编辑区域 -->
		<form action="<%=request.getContextPath()%>/plan/substituteGroup_Edit.do"	method="post" name="addForm">
			...
			<div class="infoedit">
				...
				<dl>
					...
					<dd>
						<input class="inputText" type="text" name="substituteGroup.substituteGroupId" id="substituteGroupId" value="${substituteGroup.substituteGroupId}" readonly="readonly" />
					</dd>
				</dl>
				<dl>
					<dt>
					...
					<dd>
						<input class="inputText" type="text" name="substituteGroup.substituteGroupName" id="substituteGroupName" value="${substituteGroup.substituteGroupName}" />
