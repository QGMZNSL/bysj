...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!-- 编辑区域 -->
		<form action="<%=request.getContextPath()%>/plan/textbook_Add.do"	method="post" name="addForm">
			...
			<div class="infoedit">
				...
				<dl>
					...
					<dd>
						<input class="inputText" type="text" name="textbook.syllabusCode" id="syllabusCode" value="" onchange='doSyllabusCode(this.value)'/>
				...
				<dl>
					...
					<dd>
						<span id='textbookName_span' style='color:#000;'></span>
						<input class="inputTextS" type="text" name="textbook.textbookCode" id="textbookCode" value=""/>
				...
				<dl>
					...
					<dd>
						<input class="inputText" type="text" name="textbook.textbookName" id="textbookName" value="" />
						<v:v input="textbook.textbookName" exp="s(1,20)">请输入教材名称！(不能超过20位)</v:v>
					</dd>
				</dl>
				<dl>
					<dt>
					...
					<dd>
						<input class="inputText" type="text" name="textbook.textbookEditor" id="textbookEditor" value="" />
				...
				<dl>
					...
					<dd>
						<input class="inputText" type="text" name="textbook.textbookPublisher" id="textbookPublisher" value="" />
				...
				<dl>
					...
					<dd>
						<input class="inputText" type="text" name="textbook.publishTime" id="publishTime" value="" />
				...
				<dl>
					...
					<dd>
						<input class="inputText" type="text" name="textbook.textbookPrice" id="textbookPrice" value="" />
				...
				<dl>
					...
					<dd>
						<input class="inputText" type="text" name="textbook.remarks" id="remarks" value="" />
					</dd>
				</dl>
				<div class="clear"></div>
			</div>
