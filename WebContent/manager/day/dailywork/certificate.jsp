...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!--导航---end-->
		<!--查询条件开始-->
		<h2 align="center" style="color:#048CAE">陕西省高等教育自学考试毕业证书查询</h2>
		<div style="width:600px;margin:5px auto;border:1px #cccccc solid;padding:5px;background-color:#FDF8DF">
		<form method="post" name="form1" action="c_query.do" onsubmit="return check()">
		<div style="margin-top:20px;float:left">
				<dl>
					...
					<dd style="font-size:16px;font-weight:bold;">
						<input class="inputText inputTextM" type="text" name="studIdnum"
							id="studIdnum" />
					</dd>
				</dl>
				<dl>
					...
					<dd style="font-size:16px;font-weight:bold;">
						<input class="inputText inputTextM" type="text" name="diplomaNum"
							id="diplomaNum" />&nbsp;
					</dd>
				</dl>
		</div>
		<div style="float:left">
			<input  type="submit" value="" style="border:0;width:71px;height:71px;cursor:hand;background:url(<%=request.getContextPath()%>/common/style/one-button-bg2.gif);"/>
		</div>
		</form>
		<div class="clear"></div>
		<!--查询条件end-->
