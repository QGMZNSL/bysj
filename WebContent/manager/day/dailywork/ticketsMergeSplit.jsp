...
<link href="<%=request.getContextPath() %>/common/style/style.css" rel="stylesheet" type="text/css" />
  ...
  <!--当前位置---开始-->
<div class="dqwz">
	<span>帮助</span>日常维护>>日常管理>>准考证合并拆分
</div>
<!--当前位置---结束-->
<!--查询条件开始-->
<div class="tjcx">
<form method="post" name="form1"> 
    ...
    <div class="button"><input class="inputButton" type="button" value="查 询" />
    <input class="inputButton" type="button" value="撤销合并" /></div>
<div class="clear"></div>
<!--查询条件end-->
...
<thead>
  ...
  <tr>
    ...
    <td align="center">李一楠</td>
    <td align="center">王洋</td>
  ...
  <tfoot>
  <tr>
    <td colspan="12"><span> 首页 上一页 下一页 尾页 <input type="text"
