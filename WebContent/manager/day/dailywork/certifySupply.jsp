...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="button">
			...
			<input class="inputButton inputButtonL" type="button" value="生成学历证明" />
			<input class="inputButton inputButtonL" type="button" value="生成成绩证明" />
			<input class="inputButton inputButtonL" type="button" value="成绩录入"  onclick="location.href='resultsEntry.jsp'"/>
		</div>
		<div class="clear"></div>
		<!--查询条件end-->
