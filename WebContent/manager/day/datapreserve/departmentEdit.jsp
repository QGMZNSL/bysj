...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!--编辑页面----开始-->
		<form
			action="<%=request.getContextPath()%>/day/datapreserve/pstMgr_departmentsEdit.do"
			...
			<v:bean
				...
				<div class="infoedit">
					<dl>
						...
						<dd>
							<input type="hidden" name="department.departmentCode" value="${ department.departmentCode}" />
