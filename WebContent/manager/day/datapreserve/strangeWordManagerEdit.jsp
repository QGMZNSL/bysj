...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!--导航---end-->
		<!--编辑页面----开始-->
		<form action="strangeword_doedit.do" method="post" onsubmit="return check()">
		<input  type="hidden" name="bean.strangeWordId" value="${bean.strangeWordId }"/>
		<div class="infoedit">
			<dl>
				<dt>
					生僻字：
				...
				<dd>
					<input class="inputText inputTextM" id="word" type="text" name="bean.strangeWord" value="${bean.strangeWord }" />
					<span>(必须填写)</span>
				</dd>
			</dl>
			<dl>
				...
				<dd>
					<input class="inputText inputTextM" id="pinyin" type="text" name="bean.strangeWholeWord" value="${bean.strangeWholeWord }" onfocus="getPinYing()"/>
					<span>(必须填写)</span>
				</dd>
			</dl>
			<div class="clear"></div>
