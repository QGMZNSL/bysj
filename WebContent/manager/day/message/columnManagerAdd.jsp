...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="dqwz">
		...
		<!--导航---end-->
		<form action="class_doadd.do" method="post" onsubmit="return check()" name="classform">
				...
				<dl>
					...
					<dd>
						<input class="inputText" style="width: 50px;" type="text"
							name="newsClass.classId" id="classid" />
						<span>(必须填写)</span>
					</dd>
				</dl>
				<dl>
				...
				<dl>
					...
					<dd>
						<input name="newsClass.isShow" type="radio" value="1"
							checked="checked" />
						是
						<input name="newsClass.isShow" type="radio" value="0" />
						否
					</dd>
				</dl>
				<dl>
