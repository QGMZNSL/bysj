...
public class BaseNewsArticle {
	...
	private String articleAuditStatus;//审核状态   默认0： 0未发布 1已发布
	...
	public BaseNewsArticle(int articleId, String articleTitle,
			String articleSubTitle, int classId, String articleTitleStyle,
			...
			Date articleAuditTime, String articleUnAuditReason) {
		super();
		this.articleId = articleId;
		this.articleTitle = articleTitle;
		this.articleSubTitle = articleSubTitle;
